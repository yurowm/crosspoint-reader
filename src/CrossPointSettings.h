...
class CrossPointSettings : public PersistableStore<CrossPointSettings> {
 ...
 public:
  ...
  enum FONT_FAMILY { NUNITO = 0, FONT_FAMILY_COUNT };
  ...
  // height. Values 0..3 are reserved for migrating the legacy
  // Tight/Normal/Wide/Extra Wide enum in fromJson().
