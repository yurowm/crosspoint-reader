...
#define UI_10_FONT_ID (-1482577283)
#define UI_12_FONT_ID (-198799754)
#define NUNITO_14_FONT_ID (1835371328)
#define NUNITO_16_FONT_ID (-1998845437)
#define NUNITO_18_FONT_ID (-874864380)
#define SMALL_FONT_ID (1318568710)
